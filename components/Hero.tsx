...
export default function Hero() {
      ...
      for (let i = 0; i < pts.length; i++) {
        for (let j = i + 1; j < pts.length; j++) {
          ...
          if (d < 110) {
            ...
            ctx.strokeStyle = `rgba(79,142,247,${0.09 * (1 - d / 110)})`;
            ctx.lineWidth = 0.6;
            ctx.stroke();
          }
        }
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-[#0d0d0d] overflow-hidden">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mb-8 overflow-hidden">
            <motion.h1
              ...
              style={{ color: "transparent", WebkitTextStroke: "1.5px #333" }}
            >
              Anwar.
            </motion.h1>
          </div>
      ...
      <div className="absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-[#222] to-transparent" />
    </section>
  );
}
